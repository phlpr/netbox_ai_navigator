...
- Preserve registered NetBox filters when opening a previously filtered list and fall back to its permission-checked,
  previously verified object IDs only for Navigator-specific filters.
