...
For free-text searches such as a city, site fragment, device name, or description, prefer the `q` filter. Relationship
filters such as `site` and `location` accept registered choices and must not be used with an unverified free-text value.
